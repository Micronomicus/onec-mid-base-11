...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Группа = Элементы.Добавить("ГруппаСкидок", Тип("ГруппаФормы"), Элементы.ГруппаШапкаЛево);
	...
	КнопкаФормы = Элементы.Добавить("КнопкаПересчитатьСкидку",Тип("КнопкаФормы"), Элементы.ГруппаШапкаЛево);
...
Процедура ПересчитатьТаблицы()
	...
	КонецЦикла; 
	ТабличнаяЧасть1 = Объект.Услуги;
	Для Каждого СтрокаТовары Из ТабличнаяЧасть1 Цикл
		РассчитатьСуммуСтроки(СтрокаТовары);
	КонецЦикла;
