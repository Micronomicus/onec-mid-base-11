...
ДобавитьПолеКонтактноеЛицоВГруппаШапкаПравоЗаказПокупателя (Форма);
...
Процедура ДобавитьПолеКонтактноеЛицоВГруппаШапкаПравоЗаказПокупателя(Форма)Экспорт
    ...
    НовыйЭлемент1 = Форма.Элементы.Добавить("СогласованнаяСкидка", Тип("ПолеФормы"), Форма.Элементы.ГруппаШапкаЛево);
	НовыйЭлемент1.ПутьКДанным = "Объект.СогласованнаяСкидка";
	НовыйЭлемент1.Вид = ВидПоляФормы.ПолеВвода; 
    НовыйЭлемент1.УстановитьДействие("ПриИзменении","СогласованнаяСкидкаПриИзменении");
